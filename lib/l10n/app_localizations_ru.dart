...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get infoSectionJaeggiBody =>
      'В 2008 году учёные под руководством Jaeggi опубликовали исследование, в котором примерно 19 дней ежедневных тренировок Dual N-back улучшили текучий интеллект (Gf) — способность решать новые, незнакомые задачи. С тех пор N-back стал популярным «тренажёром для мозга».\n\nНастройки по умолчанию в этом приложении взяты из того же исследования: 20 трайлов в сессии, стимул показывается 500 мс, пауза между стимулами 2500 мс, совпадения попадаются примерно в 30% случаев. Если включить адаптивный режим, уровень N будет повышаться при точности ≥80% по каждому каналу и понижаться при <50%.';
